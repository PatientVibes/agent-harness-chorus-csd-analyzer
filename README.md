...
per-form summary), a chat session with override-proposal tools, and a planned live
Chorus import flow.

Design spec: [`docs/superpowers/specs/2026-05-18-agent-app-chorus-csd-analyzer-design.md`](docs/superpowers/specs/2026-05-18-agent-app-chorus-csd-analyzer-design.md).
